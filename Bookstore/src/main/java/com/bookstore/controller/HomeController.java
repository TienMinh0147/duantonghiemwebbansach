...
import com.bookstore.untility.MailConstructor;
import com.bookstore.untility.SecurityUtility;
import com.bookstore.untility.USConstants;
...
public class HomeController {
	...
	public String listOfCreaditCards(Model model, Principal principal, HttpServletRequest request) {
		User user = userService.findByUsername(principal.getName());
		model.addAttribute("user", user);
		model.addAttribute("userPaymentList", user.getUserPaymentList());
		model.addAttribute("userShippingList", user.getUserShippingList());
	...
	public String updateUserShipping(@ModelAttribute("id") Long shippingAddressId, Principal principal, Model model) {
		...
		if (user.getId() != userShipping.getUser().getId()) {
			...
			model.addAttribute("listOfCreaditCards", true);
	...
	public String removeUserShipping(@ModelAttribute("id") 
	Long userShippingId, Principal principal, Model model) {
	...
	public String addNewShippingAddressPost(@ModelAttribute("userPayment") UserPayment userPayment,
	...
	public String newUser(Locale locale, @RequestParam("token") String token, Model model) {
		...
		// chon nguoi dung va xac dinh nguoi dung

		User user = passToken.getUser();
		String username = user.getUsername();

		UserDetails userDetails = userSecurityService.loadUserByUsername(username);
		// moi turong nguoi dung mk
